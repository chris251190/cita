              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2 flex flex-col items-center justify-center"> {/* Add flex and justify-center */}
                      <QRCode
                        className="mt-3 mb-3"
                        value={formatGoogleCalendarURL(appointment)}
                      />
                      <div className='flex justify-center items-center'> {/* Add flex and justify-center */}
                        <button
